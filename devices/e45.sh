...
if [ "$option" = "1" ]; then
  ...
  if [ "$optionubuntu" = "0" ]; then
    ...
    if [ "$ubuntuwipechannel" = "1" ]; then
      ...
      echo ""
      sleep 1
      echo "Please boot you E4.5 into bootloader/fastboot mode by pressing Power & Volume Up (+)"
  ...
  if [ "$optionubuntu" = "1" ]; then
    ...
    if [ "$optionubuntu" = "2" ]; then
      ...
      if [ "$ubuntukeepchannel" = "1" ]; then
        ...
        echo ""
        sleep 1
        echo "Please boot you E4.5 into recovery mode by pressing Power & Volume Up (+)"
