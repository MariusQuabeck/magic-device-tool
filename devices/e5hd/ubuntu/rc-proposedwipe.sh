...
if [ "$bootloadermode"==Y -o "$bootloadermode"==y -o "$bootloadermode"=="" ]; then
  ...
  then
    ...
    sleep 1
    ubuntu-device-flash touch --channel ubuntu-touch/rc-proposed/bq-aquaris.en --device vegetahd --recovery-image $HOME/.cache/magic-device-tool/recovery-vegetahd.img  --bootstrap
    echo ""
