...
if [ "$option" = "1" ]; then
  ...
  if [ "$optionubuntu" = "1" ]; then
    ...
    if [ "$ubuntuwipechannel" = "1" ]; then
      ...
      echo ""
      sleep 1
      echo "Please boot you Nexus 4 into bootloader/fastboot mode by pressing Power & Volume Down (-)"
      echo ""
      sleep 1
    ...
    if [ "$optionubuntu" = "2" ]; then
      ...
      if [ "$ubuntukeepchannel" = "1" ]; then
        ...
        echo ""
        sleep 1
        echo "Please boot you Nexus 4 into recovery mode by pressing Power & Volume Down (-)"
