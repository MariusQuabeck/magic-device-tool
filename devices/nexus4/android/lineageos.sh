...
then
  ...
  echo ""
  wget -c --quiet --show-progress --tries=10 -P $HOME/.cache/magic-device-tool/ http://people.ubuntu.com/~marius.quabeck/magic-device-tool/recoverys/twrp-3.0.2-0-mako.img
  sleep 1
  echo ""
  echo "Downloading LineageOS 14.1.."
  echo ""
  sleep 1
  wget -c --quiet --show-progress --tries=10 -P $HOME/.cache/magic-device-tool/ https://mirrorbits.lineageos.org/full/mako/20170125/lineage-14.1-20170125-nightly-mako-signed.zip
  echo ""
  ...
  echo ""
  fastboot flash recovery $HOME/.cache/magic-device-tool/twrp-3.0.2-0-mako.img
  sleep 1
  echo ""
  ...
  fastboot reboot-bootloader
  sleep 7
  fastboot boot $HOME/.cache/magic-device-tool/twrp-3.0.2-0-mako.img
  sleep 15
  adb reboot recovery
  sleep 15
  echo ""
  ...
  adb push -p $HOME/.cache/magic-device-tool/lineage-14.1-20170125-nightly-mako-signed.zip /sdcard/
  echo ""
  echo "  → open gapps zip"
