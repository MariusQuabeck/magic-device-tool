...
then
  ...
  echo ""
  sleep 1
  wget -c --quiet --show-progress --tries=10 -P $HOME/.cache/magic-device-tool/ https://mirrorbits.lineageos.org/full/hammerhead/20170524/lineage-14.1-20170524-nightly-hammerhead-signed.zip
  echo ""
  ...
  adb push -p $HOME/.cache/magic-device-tool/lineage-14.1-20170524-nightly-hammerhead-signed.zip /sdcard/
  echo ""
  echo "  → gapps zip"
  ...
  echo "Installing LineageOS 14.1.."
  echo ""
  adb shell twrp install /sdcard/lineage-14.1-20170524-nightly-hammerhead-signed.zip
  sleep 1
  echo ""
