...
then
  ...
  echo ""
  sleep 1
  wget -c --quiet --show-progress --tries=10 -P $HOME/.cache/magic-device-tool/ https://mirrorbits.lineageos.org/full/flo/20170718/lineage-14.1-20170718-nightly-flo-signed.zip
  echo ""
  ...
  adb push -p $HOME/.cache/magic-device-tool/lineage-14.1-20170718-nightly-flo-signed.zip /sdcard/
  echo ""
  echo "  → open gapps zip"
  ...
  echo ""
  adb shell twrp install /sdcard/lineage-14.1-20170718-nightly-flo-signed.zip
  sleep 1
  echo ""
