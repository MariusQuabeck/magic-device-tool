...
then
  ...
  echo ""
  sleep 1
  wget -c --quiet --show-progress --tries=10 https://download.cyanogenmod.org/get/jenkins/187670/cm-14.1-20161125-NIGHTLY-deb.zip
  echo ""
  ...
  echo ""
  echo "  → CM 14.1 zip "
  adb push -p cm-14.1-20161125-NIGHTLY-deb.zip /sdcard/
  echo ""
  echo "  → gapps zip"
