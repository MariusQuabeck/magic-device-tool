clear
echo ""
echo "Installing Cyanogenmod 12.1 without Gapps"
echo ""
sleep 1
...
then
  ...
  echo ""
  wget -c --quiet --show-progress --tries=10 http://people.ubuntu.com/~misterq/magic-device-tool/recoverys/twrp-3.0.2-0-grouper.img
  sleep 1
  echo ""
  echo "Downloading Cyanogenmod 12.1 .."
  echo ""
  sleep 1
  wget -c --quiet --show-progress --tries=10 http://get.cm/get/grouper-snapshot.zip
  echo ""
  sleep 2
  clear
  echo ""
  ...
  echo ""
  fastboot flash recovery twrp-3.0.2-0-grouper.img
  sleep 1
  echo ""
  ...
  fastboot reboot-bootloader
  sleep 7
  fastboot boot twrp-3.0.2-0-grouper.img
  sleep 15
  adb reboot recovery
  sleep 15
  echo ""
  ...
  echo ""
  echo "  → CM 12.1 zip "
  adb push -p grouper-snapshot.zip /sdcard/
  echo ""
  echo "========================================="
  sleep 1
  echo ""
  ...
  echo ""
  adb shell twrp install /sdcard/grouper-snapshot.zip
  sleep 1
  echo ""
  echo "Wipe cache.."
  echo ""
